...
void ResetDialog::initHandlers()
{
    ...
    _handlers.insert(ReqId::ID_RESET_PWD, [this](const QJsonObject& jsonObj){
        ...
        AsyncLog::getInstance().log(LogLevel::LogERROR, "response error is {}", error);
...
void ResetDialog::slot_reset_mod_finish(ReqId id, QString res, ErrorCodes err)
{
    ...
    AsyncLog::getInstance().log(LogLevel::LogINFO, "this is ResetDialog::slot_reset_mod_finish");
...
void ResetDialog::on_btn_get_clicked()
{
    ...
    AsyncLog::getInstance().log(LogLevel::LogINFO, "in reset get verify");
...
void ResetDialog::on_btn_confirm_clicked()
{
...
void ResetDialog::showTip(QString str, bool flag)
{
    if(flag)
    {
        ui->label_err->setProperty("state","normal");
    }
    else
    {
        ui->label_err->setProperty("state","err");
    }
    ui->label_err->setText(str);
    repolish(ui->label_err);
}
